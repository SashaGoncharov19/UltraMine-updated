...
{
	public static final int READ_TIMEOUT = parseIntOr(System.getProperty("fml.readTimeout","30"),30);
	public static final int LOGIN_TIMEOUT = parseIntOr(System.getProperty("fml.loginTimeout","600"),600);

	//Replacement for log4j 2.0-beta9 Integers.parseInt(String, int), removed in log4j 2.x
